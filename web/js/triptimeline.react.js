...
var TripList = React.createClass({
    render: function() {
        var tripNodes = this.props.trips.map(function(trip) {
            return (
                <TripBox tripName={trip.tripName} tripDesc={trip.tripDesc} date={trip.createdAt} key={trip.id} pos={trip.posTimeline} link={trip.link} userName={trip.userName} linkUser={trip.linkUser} profilePic={trip.profilePic}>{trip.tripDesc}</TripBox>
            );
        });
            ...
            <dd className={this.props.pos}>
                ...
                <div className="events">
                    ...
                    <div className="events-body">
                        <h4 className="events-heading">{this.props.tripName} by <a href={this.props.linkUser}>{this.props.userName}</a></h4>
