 ...
 */
;if('undefined'==typeof jQuery)throw new Error('Bootstrap\'s JavaScript requires jQuery');+function(t){var e=t.fn.jquery.split(' ')[0].split('.');if(e[0]<2&&e[1]<9||1==e[0]&&9==e[1]&&e[2]<1)throw new Error('Bootstrap\'s JavaScript requires jQuery version 1.9.1 or higher')}(jQuery),+function(t){'use strict';function e(){var i=document.createElement('bootstrap'),e={WebkitTransition:'webkitTransitionEnd',MozTransition:'transitionend',OTransition:'oTransitionEnd otransitionend',transition:'transitionend'};for(var t in e)if(void 0!==i.style[t])return{end:e[t]};return!1};t.fn.emulateTransitionEnd=function(e){var i=!1,s=this;t(this).one('bsTransitionEnd',function(){i=!0});var o=function(){i||t(s).trigger(t.support.transition.end)};return setTimeout(o,e),this},t(function(){t.support.transition=e(),t.support.transition&&(t.event.special.bsTransitionEnd={bindType:t.support.transition.end,delegateType:t.support.transition.end,handle:function(e){return t(e.target).is(this)?e.handleObj.handler.apply(this,arguments):void 0}})})}(jQuery),+function(t){'use strict';function s(i){return this.each(function(){var o=t(this),s=o.data('bs.alert');s||o.data('bs.alert',s=new e(this)),'string'==typeof i&&s[i].call(o)})};var i='[data-dismiss="alert"]',e=function(e){t(e).on('click',i,this.close)};e.VERSION='3.3.0',e.TRANSITION_DURATION=150,e.prototype.close=function(i){function r(){o.detach().trigger('closed.bs.alert').remove()};var n=t(this),s=n.attr('data-target');s||(s=n.attr('href'),s=s&&s.replace(/.*(?=#[^\s]*$)/,''));var o=t(s);i&&i.preventDefault(),o.length||(o=n.closest('.alert')),o.trigger(i=t.Event('close.bs.alert')),i.isDefaultPrevented()||(o.removeClass('in'),t.support.transition&&o.hasClass('fade')?o.one('bsTransitionEnd',r).emulateTransitionEnd(e.TRANSITION_DURATION):r())};var o=t.fn.alert;t.fn.alert=s,t.fn.alert.Constructor=e,t.fn.alert.noConflict=function(){return t.fn.alert=o,this},t(document).on('click.bs.alert.data-api',i,e.prototype.close)}(jQuery),+function(t){'use strict';function i(i){return this.each(function(){var s=t(this),o=s.data('bs.button'),n='object'==typeof i&&i;o||s.data('bs.button',o=new e(this,n)),'toggle'==i?o.toggle():i&&o.setState(i)})};var e=function(i,o){this.$element=t(i),this.options=t.extend({},e.DEFAULTS,o),this.isLoading=!1};e.VERSION='3.3.0',e.DEFAULTS={loadingText:'loading...'},e.prototype.setState=function(e){var o='disabled',i=this.$element,n=i.is('input')?'val':'html',s=i.data();e+='Text',null==s.resetText&&i.data('resetText',i[n]()),setTimeout(t.proxy(function(){i[n](null==s[e]?this.options[e]:s[e]),'loadingText'==e?(this.isLoading=!0,i.addClass(o).attr(o,o)):this.isLoading&&(this.isLoading=!1,i.removeClass(o).removeAttr(o))},this),0)},e.prototype.toggle=function(){var e=!0,i=this.$element.closest('[data-toggle="buttons"]');if(i.length){var t=this.$element.find('input');'radio'==t.prop('type')&&(t.prop('checked')&&this.$element.hasClass('active')?e=!1:i.find('.active').removeClass('active')),e&&t.prop('checked',!this.$element.hasClass('active')).trigger('change')}
else this.$element.attr('aria-pressed',!this.$element.hasClass('active'));e&&this.$element.toggleClass('active')};var o=t.fn.button;t.fn.button=i,t.fn.button.Constructor=e,t.fn.button.noConflict=function(){return t.fn.button=o,this},t(document).on('click.bs.button.data-api','[data-toggle^="button"]',function(e){var o=t(e.target);o.hasClass('btn')||(o=o.closest('.btn')),i.call(o,'toggle'),e.preventDefault()}).on('focus.bs.button.data-api blur.bs.button.data-api','[data-toggle^="button"]',function(e){t(e.target).closest('.btn').toggleClass('focus','focus'==e.type)})}(jQuery),+function(t){'use strict';function i(i){return this.each(function(){var s=t(this),o=s.data('bs.carousel'),n=t.extend({},e.DEFAULTS,s.data(),'object'==typeof i&&i),r='string'==typeof i?i:n.slide;o||s.data('bs.carousel',o=new e(this,n)),'number'==typeof i?o.to(i):r?o[r]():n.interval&&o.pause().cycle()})};var e=function(e,i){this.$element=t(e),this.$indicators=this.$element.find('.carousel-indicators'),this.options=i,this.paused=this.sliding=this.interval=this.$active=this.$items=null,this.options.keyboard&&this.$element.on('keydown.bs.carousel',t.proxy(this.keydown,this)),'hover'==this.options.pause&&!('ontouchstart'in document.documentElement)&&this.$element.on('mouseenter.bs.carousel',t.proxy(this.pause,this)).on('mouseleave.bs.carousel',t.proxy(this.cycle,this))};e.VERSION='3.3.0',e.TRANSITION_DURATION=600,e.DEFAULTS={interval:5e3,pause:'hover',wrap:!0,keyboard:!0},e.prototype.keydown=function(t){switch(t.which){case 37:this.prev();break;case 39:this.next();break;default:return};t.preventDefault()},e.prototype.cycle=function(e){return e||(this.paused=!1),this.interval&&clearInterval(this.interval),this.options.interval&&!this.paused&&(this.interval=setInterval(t.proxy(this.next,this),this.options.interval)),this},e.prototype.getItemIndex=function(t){return this.$items=t.parent().children('.item'),this.$items.index(t||this.$active)},e.prototype.getItemForDirection=function(t,e){var i='prev'==t?-1:1,o=this.getItemIndex(e),s=(o+i)%this.$items.length;return this.$items.eq(s)},e.prototype.to=function(t){var i=this,e=this.getItemIndex(this.$active=this.$element.find('.item.active'));return t>this.$items.length-1||0>t?void 0:this.sliding?this.$element.one('slid.bs.carousel',function(){i.to(t)}):e==t?this.pause().cycle():this.slide(t>e?'next':'prev',this.$items.eq(t))},e.prototype.pause=function(e){return e||(this.paused=!0),this.$element.find('.next, .prev').length&&t.support.transition&&(this.$element.trigger(t.support.transition.end),this.cycle(!0)),this.interval=clearInterval(this.interval),this},e.prototype.next=function(){return this.sliding?void 0:this.slide('next')},e.prototype.prev=function(){return this.sliding?void 0:this.slide('prev')},e.prototype.slide=function(i,o){var r=this.$element.find('.item.active'),s=o||this.getItemForDirection(i,r),p=this.interval,n='next'==i?'left':'right',f='next'==i?'first':'last',c=this;if(!s.length){if(!this.options.wrap)return;s=this.$element.find('.item')[f]()};if(s.hasClass('active'))return this.sliding=!1;var h=s[0],d=t.Event('slide.bs.carousel',{relatedTarget:h,direction:n});if(this.$element.trigger(d),!d.isDefaultPrevented()){if(this.sliding=!0,p&&this.pause(),this.$indicators.length){this.$indicators.find('.active').removeClass('active');var l=t(this.$indicators.children()[this.getItemIndex(s)]);l&&l.addClass('active')};var a=t.Event('slid.bs.carousel',{relatedTarget:h,direction:n});return t.support.transition&&this.$element.hasClass('slide')?(s.addClass(i),s[0].offsetWidth,r.addClass(n),s.addClass(n),r.one('bsTransitionEnd',function(){s.removeClass([i,n].join(' ')).addClass('active'),r.removeClass(['active',n].join(' ')),c.sliding=!1,setTimeout(function(){c.$element.trigger(a)},0)}).emulateTransitionEnd(e.TRANSITION_DURATION)):(r.removeClass('active'),s.addClass('active'),this.sliding=!1,this.$element.trigger(a)),p&&this.cycle(),this}};var s=t.fn.carousel;t.fn.carousel=i,t.fn.carousel.Constructor=e,t.fn.carousel.noConflict=function(){return t.fn.carousel=s,this};var o=function(e){var a,o=t(this),s=t(o.attr('data-target')||(a=o.attr('href'))&&a.replace(/.*(?=#[^\s]+$)/,''));if(s.hasClass('carousel')){var r=t.extend({},s.data(),o.data()),n=o.attr('data-slide-to');n&&(r.interval=!1),i.call(s,r),n&&s.data('bs.carousel').to(n),e.preventDefault()}};t(document).on('click.bs.carousel.data-api','[data-slide]',o).on('click.bs.carousel.data-api','[data-slide-to]',o),t(window).on('load',function(){t('[data-ride="carousel"]').each(function(){var e=t(this);i.call(e,e.data())})})}(jQuery),+function(t){'use strict';function o(e){var i,o=e.attr('data-target')||(i=e.attr('href'))&&i.replace(/.*(?=#[^\s]+$)/,'');return t(o)};function i(i){return this.each(function(){var s=t(this),o=s.data('bs.collapse'),n=t.extend({},e.DEFAULTS,s.data(),'object'==typeof i&&i);!o&&n.toggle&&'show'==i&&(n.toggle=!1),o||s.data('bs.collapse',o=new e(this,n)),'string'==typeof i&&o[i]()})};var e=function(i,o){this.$element=t(i),this.options=t.extend({},e.DEFAULTS,o),this.$trigger=t(this.options.trigger).filter('[href="#'+i.id+'"], [data-target="#'+i.id+'"]'),this.transitioning=null,this.options.parent?this.$parent=this.getParent():this.addAriaAndCollapsedClass(this.$element,this.$trigger),this.options.toggle&&this.toggle()};e.VERSION='3.3.0',e.TRANSITION_DURATION=350,e.DEFAULTS={toggle:!0,trigger:'[data-toggle="collapse"]'},e.prototype.dimension=function(){var t=this.$element.hasClass('width');return t?'width':'height'},e.prototype.show=function(){if(!this.transitioning&&!this.$element.hasClass('in')){var n,o=this.$parent&&this.$parent.find('> .panel').children('.in, .collapsing');if(!(o&&o.length&&(n=o.data('bs.collapse'),n&&n.transitioning))){var a=t.Event('show.bs.collapse');if(this.$element.trigger(a),!a.isDefaultPrevented()){o&&o.length&&(i.call(o,'hide'),n||o.data('bs.collapse',null));var s=this.dimension();this.$element.removeClass('collapse').addClass('collapsing')[s](0).attr('aria-expanded',!0),this.$trigger.removeClass('collapsed').attr('aria-expanded',!0),this.transitioning=1;var r=function(){this.$element.removeClass('collapsing').addClass('collapse in')[s](''),this.transitioning=0,this.$element.trigger('shown.bs.collapse')};if(!t.support.transition)return r.call(this);var l=t.camelCase(['scroll',s].join('-'));this.$element.one('bsTransitionEnd',t.proxy(r,this)).emulateTransitionEnd(e.TRANSITION_DURATION)[s](this.$element[0][l])}}}},e.prototype.hide=function(){if(!this.transitioning&&this.$element.hasClass('in')){var s=t.Event('hide.bs.collapse');if(this.$element.trigger(s),!s.isDefaultPrevented()){var i=this.dimension();this.$element[i](this.$element[i]())[0].offsetHeight,this.$element.addClass('collapsing').removeClass('collapse in').attr('aria-expanded',!1),this.$trigger.addClass('collapsed').attr('aria-expanded',!1),this.transitioning=1;var o=function(){this.transitioning=0,this.$element.removeClass('collapsing').addClass('collapse').trigger('hidden.bs.collapse')};return t.support.transition?void this.$element[i](0).one('bsTransitionEnd',t.proxy(o,this)).emulateTransitionEnd(e.TRANSITION_DURATION):o.call(this)}}},e.prototype.toggle=function(){this[this.$element.hasClass('in')?'hide':'show']()},e.prototype.getParent=function(){return t(this.options.parent).find('[data-toggle="collapse"][data-parent="'+this.options.parent+'"]').each(t.proxy(function(e,i){var s=t(i);this.addAriaAndCollapsedClass(o(s),s)},this)).end()},e.prototype.addAriaAndCollapsedClass=function(t,e){var i=t.hasClass('in');t.attr('aria-expanded',i),e.toggleClass('collapsed',!i).attr('aria-expanded',i)};var s=t.fn.collapse;t.fn.collapse=i,t.fn.collapse.Constructor=e,t.fn.collapse.noConflict=function(){return t.fn.collapse=s,this},t(document).on('click.bs.collapse.data-api','[data-toggle="collapse"]',function(e){var s=t(this);s.attr('data-target')||e.preventDefault();var n=o(s),r=n.data('bs.collapse'),a=r?'toggle':t.extend({},s.data(),{trigger:this});i.call(n,a)})}(jQuery),+function(t){'use strict';function o(e){e&&3===e.which||(t(r).remove(),t(i).each(function(){var o=t(this),i=s(o),n={relatedTarget:this};i.hasClass('open')&&(i.trigger(e=t.Event('hide.bs.dropdown',n)),e.isDefaultPrevented()||(o.attr('aria-expanded','false'),i.removeClass('open').trigger('hidden.bs.dropdown',n)))}))};function s(e){var i=e.attr('data-target');i||(i=e.attr('href'),i=i&&/#[A-Za-z]/.test(i)&&i.replace(/.*(?=#[^\s]*$)/,''));var o=i&&t(i);return o&&o.length?o:e.parent()};function a(i){return this.each(function(){var o=t(this),s=o.data('bs.dropdown');s||o.data('bs.dropdown',s=new e(this)),'string'==typeof i&&s[i].call(o)})};var r='.dropdown-backdrop',i='[data-toggle="dropdown"]',e=function(e){t(e).on('click.bs.dropdown',this.toggle)};e.VERSION='3.3.0',e.prototype.toggle=function(e){var n=t(this);if(!n.is('.disabled, :disabled')){var i=s(n),a=i.hasClass('open');if(o(),!a){'ontouchstart'in document.documentElement&&!i.closest('.navbar-nav').length&&t('<div class="dropdown-backdrop"/>').insertAfter(t(this)).on('click',o);var r={relatedTarget:this};if(i.trigger(e=t.Event('show.bs.dropdown',r)),e.isDefaultPrevented())return;n.trigger('focus').attr('aria-expanded','true'),i.toggleClass('open').trigger('shown.bs.dropdown',r)};return!1}},e.prototype.keydown=function(e){if(/(38|40|27|32)/.test(e.which)){var a=t(this);if(e.preventDefault(),e.stopPropagation(),!a.is('.disabled, :disabled')){var r=s(a),h=r.hasClass('open');if(!h&&27!=e.which||h&&27==e.which)return 27==e.which&&r.find(i).trigger('focus'),a.trigger('click');var l=' li:not(.divider):visible a',n=r.find('[role="menu"]'+l+', [role="listbox"]'+l);if(n.length){var o=n.index(e.target);38==e.which&&o>0&&o--,40==e.which&&o<n.length-1&&o++,~o||(o=0),n.eq(o).trigger('focus')}}}};var n=t.fn.dropdown;t.fn.dropdown=a,t.fn.dropdown.Constructor=e,t.fn.dropdown.noConflict=function(){return t.fn.dropdown=n,this},t(document).on('click.bs.dropdown.data-api',o).on('click.bs.dropdown.data-api','.dropdown form',function(t){t.stopPropagation()}).on('click.bs.dropdown.data-api',i,e.prototype.toggle).on('keydown.bs.dropdown.data-api',i,e.prototype.keydown).on('keydown.bs.dropdown.data-api','[role="menu"]',e.prototype.keydown).on('keydown.bs.dropdown.data-api','[role="listbox"]',e.prototype.keydown)}(jQuery),+function(t){'use strict';function i(i,o){return this.each(function(){var n=t(this),s=n.data('bs.modal'),r=t.extend({},e.DEFAULTS,n.data(),'object'==typeof i&&i);s||n.data('bs.modal',s=new e(this,r)),'string'==typeof i?s[i](o):r.show&&s.show(o)})};var e=function(e,i){this.options=i,this.$body=t(document.body),this.$element=t(e),this.$backdrop=this.isShown=null,this.scrollbarWidth=0,this.options.remote&&this.$element.find('.modal-content').load(this.options.remote,t.proxy(function(){this.$element.trigger('loaded.bs.modal')},this))};e.VERSION='3.3.0',e.TRANSITION_DURATION=300,e.BACKDROP_TRANSITION_DURATION=150,e.DEFAULTS={backdrop:!0,keyboard:!0,show:!0},e.prototype.toggle=function(t){return this.isShown?this.hide():this.show(t)},e.prototype.show=function(i){var o=this,s=t.Event('show.bs.modal',{relatedTarget:i});this.$element.trigger(s),this.isShown||s.isDefaultPrevented()||(this.isShown=!0,this.checkScrollbar(),this.$body.addClass('modal-open'),this.setScrollbar(),this.escape(),this.$element.on('click.dismiss.bs.modal','[data-dismiss="modal"]',t.proxy(this.hide,this)),this.backdrop(function(){var n=t.support.transition&&o.$element.hasClass('fade');o.$element.parent().length||o.$element.appendTo(o.$body),o.$element.show().scrollTop(0),n&&o.$element[0].offsetWidth,o.$element.addClass('in').attr('aria-hidden',!1),o.enforceFocus();var s=t.Event('shown.bs.modal',{relatedTarget:i});n?o.$element.find('.modal-dialog').one('bsTransitionEnd',function(){o.$element.trigger('focus').trigger(s)}).emulateTransitionEnd(e.TRANSITION_DURATION):o.$element.trigger('focus').trigger(s)}))},e.prototype.hide=function(i){i&&i.preventDefault(),i=t.Event('hide.bs.modal'),this.$element.trigger(i),this.isShown&&!i.isDefaultPrevented()&&(this.isShown=!1,this.escape(),t(document).off('focusin.bs.modal'),this.$element.removeClass('in').attr('aria-hidden',!0).off('click.dismiss.bs.modal'),t.support.transition&&this.$element.hasClass('fade')?this.$element.one('bsTransitionEnd',t.proxy(this.hideModal,this)).emulateTransitionEnd(e.TRANSITION_DURATION):this.hideModal())},e.prototype.enforceFocus=function(){t(document).off('focusin.bs.modal').on('focusin.bs.modal',t.proxy(function(t){this.$element[0]===t.target||this.$element.has(t.target).length||this.$element.trigger('focus')},this))},e.prototype.escape=function(){this.isShown&&this.options.keyboard?this.$element.on('keydown.dismiss.bs.modal',t.proxy(function(t){27==t.which&&this.hide()},this)):this.isShown||this.$element.off('keydown.dismiss.bs.modal')},e.prototype.hideModal=function(){var t=this;this.$element.hide(),this.backdrop(function(){t.$body.removeClass('modal-open'),t.resetScrollbar(),t.$element.trigger('hidden.bs.modal')})},e.prototype.removeBackdrop=function(){this.$backdrop&&this.$backdrop.remove(),this.$backdrop=null},e.prototype.backdrop=function(i){var r=this,n=this.$element.hasClass('fade')?'fade':'';if(this.isShown&&this.options.backdrop){var s=t.support.transition&&n;if(this.$backdrop=t('<div class="modal-backdrop '+n+'" />').prependTo(this.$element).on('click.dismiss.bs.modal',t.proxy(function(t){t.target===t.currentTarget&&('static'==this.options.backdrop?this.$element[0].focus.call(this.$element[0]):this.hide.call(this))},this)),s&&this.$backdrop[0].offsetWidth,this.$backdrop.addClass('in'),!i)return;s?this.$backdrop.one('bsTransitionEnd',i).emulateTransitionEnd(e.BACKDROP_TRANSITION_DURATION):i()}
...
else i&&i()},e.prototype.checkScrollbar=function(){this.scrollbarWidth=this.measureScrollbar()},e.prototype.setScrollbar=function(){var t=parseInt(this.$body.css('padding-right')||0,10);this.scrollbarWidth&&this.$body.css('padding-right',t+this.scrollbarWidth)},e.prototype.resetScrollbar=function(){this.$body.css('padding-right','')},e.prototype.measureScrollbar=function(){if(document.body.clientWidth>=window.innerWidth)return 0;var t=document.createElement('div');t.className='modal-scrollbar-measure',this.$body.append(t);var e=t.offsetWidth-t.clientWidth;return this.$body[0].removeChild(t),e};var o=t.fn.modal;t.fn.modal=i,t.fn.modal.Constructor=e,t.fn.modal.noConflict=function(){return t.fn.modal=o,this},t(document).on('click.bs.modal.data-api','[data-toggle="modal"]',function(e){var o=t(this),n=o.attr('href'),s=t(o.attr('data-target')||n&&n.replace(/.*(?=#[^\s]+$)/,'')),r=s.data('bs.modal')?'toggle':t.extend({remote:!/#/.test(n)&&n},s.data(),o.data());o.is('a')&&e.preventDefault(),s.one('show.bs.modal',function(t){t.isDefaultPrevented()||s.one('hidden.bs.modal',function(){o.is(':visible')&&o.trigger('focus')})}),i.call(s,r,this)})}(jQuery),+function(t){'use strict';function o(i){return this.each(function(){var n=t(this),o=n.data('bs.tooltip'),s='object'==typeof i&&i,r=s&&s.selector;(o||'destroy'!=i)&&(r?(o||n.data('bs.tooltip',o={}),o[r]||(o[r]=new e(this,s))):o||n.data('bs.tooltip',o=new e(this,s)),'string'==typeof i&&o[i]())})};var e=function(t,e){this.type=this.options=this.enabled=this.timeout=this.hoverState=this.$element=null,this.init('tooltip',t,e)};e.VERSION='3.3.0',e.TRANSITION_DURATION=150,e.DEFAULTS={animation:!0,placement:'top',selector:!1,template:'<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>',trigger:'hover focus',title:'',delay:0,html:!1,container:!1,viewport:{selector:'body',padding:0}},e.prototype.init=function(e,i,o){this.enabled=!0,this.type=e,this.$element=t(i),this.options=this.getOptions(o),this.$viewport=this.options.viewport&&t(this.options.viewport.selector||this.options.viewport);for(var n=this.options.trigger.split(' '),r=n.length;r--;){var s=n[r];if('click'==s)this.$element.on('click.'+this.type,this.options.selector,t.proxy(this.toggle,this));else if('manual'!=s){var a='hover'==s?'mouseenter':'focusin',l='hover'==s?'mouseleave':'focusout';this.$element.on(a+'.'+this.type,this.options.selector,t.proxy(this.enter,this)),this.$element.on(l+'.'+this.type,this.options.selector,t.proxy(this.leave,this))}};this.options.selector?this._options=t.extend({},this.options,{trigger:'manual',selector:''}):this.fixTitle()},e.prototype.getDefaults=function(){return e.DEFAULTS},e.prototype.getOptions=function(e){return e=t.extend({},this.getDefaults(),this.$element.data(),e),e.delay&&'number'==typeof e.delay&&(e.delay={show:e.delay,hide:e.delay}),e},e.prototype.getDelegateOptions=function(){var e={},i=this.getDefaults();return this._options&&t.each(this._options,function(t,o){i[t]!=o&&(e[t]=o)}),e},e.prototype.enter=function(e){var i=e instanceof this.constructor?e:t(e.currentTarget).data('bs.'+this.type);return i&&i.$tip&&i.$tip.is(':visible')?void(i.hoverState='in'):(i||(i=new this.constructor(e.currentTarget,this.getDelegateOptions()),t(e.currentTarget).data('bs.'+this.type,i)),clearTimeout(i.timeout),i.hoverState='in',i.options.delay&&i.options.delay.show?void(i.timeout=setTimeout(function(){'in'==i.hoverState&&i.show()},i.options.delay.show)):i.show())},e.prototype.leave=function(e){var i=e instanceof this.constructor?e:t(e.currentTarget).data('bs.'+this.type);return i||(i=new this.constructor(e.currentTarget,this.getDelegateOptions()),t(e.currentTarget).data('bs.'+this.type,i)),clearTimeout(i.timeout),i.hoverState='out',i.options.delay&&i.options.delay.hide?void(i.timeout=setTimeout(function(){'out'==i.hoverState&&i.hide()},i.options.delay.hide)):i.hide()},e.prototype.show=function(){var f=t.Event('show.bs.'+this.type);if(this.hasContent()&&this.enabled){this.$element.trigger(f);var m=t.contains(this.$element[0].ownerDocument.documentElement,this.$element[0]);if(f.isDefaultPrevented()||!m)return;var s=this,o=this.tip(),c=this.getUID(this.type);this.setContent(),o.attr('id',c),this.$element.attr('aria-describedby',c),this.options.animation&&o.addClass('fade');var i='function'==typeof this.options.placement?this.options.placement.call(this,o[0],this.$element[0]):this.options.placement,d=/\s?auto?\s?/i,p=d.test(i);p&&(i=i.replace(d,'')||'top'),o.detach().css({top:0,left:0,display:'block'}).addClass(i).data('bs.'+this.type,this),this.options.container?o.appendTo(this.options.container):o.insertAfter(this.$element);var n=this.getPosition(),a=o[0].offsetWidth,l=o[0].offsetHeight;if(p){var g=i,v=this.options.container?t(this.options.container):this.$element.parent(),r=this.getPosition(v);i='bottom'==i&&n.bottom+l>r.bottom?'top':'top'==i&&n.top-l<r.top?'bottom':'right'==i&&n.right+a>r.width?'left':'left'==i&&n.left-a<r.left?'right':i,o.removeClass(g).addClass(i)};var u=this.getCalculatedOffset(i,n,a,l);this.applyPlacement(u,i);var h=function(){var t=s.hoverState;s.$element.trigger('shown.bs.'+s.type),s.hoverState=null,'out'==t&&s.leave(s)};t.support.transition&&this.$tip.hasClass('fade')?o.one('bsTransitionEnd',h).emulateTransitionEnd(e.TRANSITION_DURATION):h()}},e.prototype.applyPlacement=function(e,i){var o=this.tip(),f=o[0].offsetWidth,a=o[0].offsetHeight,l=parseInt(o.css('margin-top'),10),h=parseInt(o.css('margin-left'),10);isNaN(l)&&(l=0),isNaN(h)&&(h=0),e.top=e.top+l,e.left=e.left+h,t.offset.setOffset(o[0],t.extend({using:function(t){o.css({top:Math.round(t.top),left:Math.round(t.left)})}},e),0),o.addClass('in');var d=o[0].offsetWidth,n=o[0].offsetHeight;'top'==i&&n!=a&&(e.top=e.top+a-n);var s=this.getViewportAdjustedDelta(i,e,d,n);s.left?e.left+=s.left:e.top+=s.top;var r=/top|bottom/.test(i),p=r?2*s.left-f+d:2*s.top-a+n,c=r?'offsetWidth':'offsetHeight';o.offset(e),this.replaceArrow(p,o[0][c],r)},e.prototype.replaceArrow=function(t,e,i){this.arrow().css(i?'left':'top',50*(1-t/e)+'%').css(i?'top':'left','')},e.prototype.setContent=function(){var t=this.tip(),e=this.getTitle();t.find('.tooltip-inner')[this.options.html?'html':'text'](e),t.removeClass('fade in top bottom left right')},e.prototype.hide=function(i){function r(){'in'!=o.hoverState&&s.detach(),o.$element.removeAttr('aria-describedby').trigger('hidden.bs.'+o.type),i&&i()};var o=this,s=this.tip(),n=t.Event('hide.bs.'+this.type);return this.$element.trigger(n),n.isDefaultPrevented()?void 0:(s.removeClass('in'),t.support.transition&&this.$tip.hasClass('fade')?s.one('bsTransitionEnd',r).emulateTransitionEnd(e.TRANSITION_DURATION):r(),this.hoverState=null,this)},e.prototype.fixTitle=function(){var t=this.$element;(t.attr('title')||'string'!=typeof t.attr('data-original-title'))&&t.attr('data-original-title',t.attr('title')||'').attr('title','')},e.prototype.hasContent=function(){return this.getTitle()},e.prototype.getPosition=function(e){e=e||this.$element;var s=e[0],o='BODY'==s.tagName,i=s.getBoundingClientRect();null==i.width&&(i=t.extend({},i,{width:i.right-i.left,height:i.bottom-i.top}));var n=o?{top:0,left:0}:e.offset(),r={scroll:o?document.documentElement.scrollTop||document.body.scrollTop:e.scrollTop()},a=o?{width:t(window).width(),height:t(window).height()}:null;return t.extend({},i,r,a,n)},e.prototype.getCalculatedOffset=function(t,e,i,o){return'bottom'==t?{top:e.top+e.height,left:e.left+e.width/2-i/2}:'top'==t?{top:e.top-o,left:e.left+e.width/2-i/2}:'left'==t?{top:e.top+e.height/2-o/2,left:e.left-i}:{top:e.top+e.height/2-o/2,left:e.left+e.width}},e.prototype.getViewportAdjustedDelta=function(t,e,o,r){var s={top:0,left:0};if(!this.$viewport)return s;var n=this.options.viewport&&this.options.viewport.padding||0,i=this.getPosition(this.$viewport);if(/right|left/.test(t)){var h=e.top-n-i.scroll,d=e.top+n-i.scroll+r;h<i.top?s.top=i.top-h:d>i.top+i.height&&(s.top=i.top+i.height-d)}
else{var a=e.left-n,l=e.left+n+o;a<i.left?s.left=i.left-a:l>i.width&&(s.left=i.left+i.width-l)};return s},e.prototype.getTitle=function(){var i,e=this.$element,t=this.options;return i=e.attr('data-original-title')||('function'==typeof t.title?t.title.call(e[0]):t.title)},e.prototype.getUID=function(t){do t+=~~(1e6*Math.random());while(document.getElementById(t));return t},e.prototype.tip=function(){return this.$tip=this.$tip||t(this.options.template)},e.prototype.arrow=function(){return this.$arrow=this.$arrow||this.tip().find('.tooltip-arrow')},e.prototype.enable=function(){this.enabled=!0},e.prototype.disable=function(){this.enabled=!1},e.prototype.toggleEnabled=function(){this.enabled=!this.enabled},e.prototype.toggle=function(e){var i=this;e&&(i=t(e.currentTarget).data('bs.'+this.type),i||(i=new this.constructor(e.currentTarget,this.getDelegateOptions()),t(e.currentTarget).data('bs.'+this.type,i))),i.tip().hasClass('in')?i.leave(i):i.enter(i)},e.prototype.destroy=function(){var t=this;clearTimeout(this.timeout),this.hide(function(){t.$element.off('.'+t.type).removeData('bs.'+t.type)})};var i=t.fn.tooltip;t.fn.tooltip=o,t.fn.tooltip.Constructor=e,t.fn.tooltip.noConflict=function(){return t.fn.tooltip=i,this}}(jQuery),+function(t){'use strict';function o(i){return this.each(function(){var n=t(this),o=n.data('bs.popover'),s='object'==typeof i&&i,r=s&&s.selector;(o||'destroy'!=i)&&(r?(o||n.data('bs.popover',o={}),o[r]||(o[r]=new e(this,s))):o||n.data('bs.popover',o=new e(this,s)),'string'==typeof i&&o[i]())})};var e=function(t,e){this.init('popover',t,e)};if(!t.fn.tooltip)throw new Error('Popover requires tooltip.js');e.VERSION='3.3.0',e.DEFAULTS=t.extend({},t.fn.tooltip.Constructor.DEFAULTS,{placement:'right',trigger:'click',content:'',template:'<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>'}),e.prototype=t.extend({},t.fn.tooltip.Constructor.prototype),e.prototype.constructor=e,e.prototype.getDefaults=function(){return e.DEFAULTS},e.prototype.setContent=function(){var t=this.tip(),i=this.getTitle(),e=this.getContent();t.find('.popover-title')[this.options.html?'html':'text'](i),t.find('.popover-content').children().detach().end()[this.options.html?'string'==typeof e?'html':'append':'text'](e),t.removeClass('fade top bottom left right in'),t.find('.popover-title').html()||t.find('.popover-title').hide()},e.prototype.hasContent=function(){return this.getTitle()||this.getContent()},e.prototype.getContent=function(){var e=this.$element,t=this.options;return e.attr('data-content')||('function'==typeof t.content?t.content.call(e[0]):t.content)},e.prototype.arrow=function(){return this.$arrow=this.$arrow||this.tip().find('.arrow')},e.prototype.tip=function(){return this.$tip||(this.$tip=t(this.options.template)),this.$tip};var i=t.fn.popover;t.fn.popover=o,t.fn.popover.Constructor=e,t.fn.popover.noConflict=function(){return t.fn.popover=i,this}}(jQuery),+function(t){'use strict';function e(i,o){var s=t.proxy(this.process,this);this.$body=t('body'),this.$scrollElement=t(t(i).is('body')?window:i),this.options=t.extend({},e.DEFAULTS,o),this.selector=(this.options.target||'')+' .nav li > a',this.offsets=[],this.targets=[],this.activeTarget=null,this.scrollHeight=0,this.$scrollElement.on('scroll.bs.scrollspy',s),this.refresh(),this.process()};function i(i){return this.each(function(){var s=t(this),o=s.data('bs.scrollspy'),n='object'==typeof i&&i;o||s.data('bs.scrollspy',o=new e(this,n)),'string'==typeof i&&o[i]()})};e.VERSION='3.3.0',e.DEFAULTS={offset:10},e.prototype.getScrollHeight=function(){return this.$scrollElement[0].scrollHeight||Math.max(this.$body[0].scrollHeight,document.documentElement.scrollHeight)},e.prototype.refresh=function(){var i='offset',o=0;t.isWindow(this.$scrollElement[0])||(i='position',o=this.$scrollElement.scrollTop()),this.offsets=[],this.targets=[],this.scrollHeight=this.getScrollHeight();var e=this;this.$body.find(this.selector).map(function(){var n=t(this),s=n.data('target')||n.attr('href'),e=/^#./.test(s)&&t(s);return e&&e.length&&e.is(':visible')&&[[e[i]().top+o,s]]||null}).sort(function(t,e){return t[0]-e[0]}).each(function(){e.offsets.push(this[0]),e.targets.push(this[1])})},e.prototype.process=function(){var t,i=this.$scrollElement.scrollTop()+this.options.offset,n=this.getScrollHeight(),r=this.options.offset+n-this.$scrollElement.height(),e=this.offsets,o=this.targets,s=this.activeTarget;if(this.scrollHeight!=n&&this.refresh(),i>=r)return s!=(t=o[o.length-1])&&this.activate(t);if(s&&i<e[0])return this.activeTarget=null,this.clear();for(t=e.length;t--;)s!=o[t]&&i>=e[t]&&(!e[t+1]||i<=e[t+1])&&this.activate(o[t])},e.prototype.activate=function(e){this.activeTarget=e,this.clear();var o=this.selector+'[data-target="'+e+'"],'+this.selector+'[href="'+e+'"]',i=t(o).parents('li').addClass('active');i.parent('.dropdown-menu').length&&(i=i.closest('li.dropdown').addClass('active')),i.trigger('activate.bs.scrollspy')},e.prototype.clear=function(){t(this.selector).parentsUntil(this.options.target,'.active').removeClass('active')};var o=t.fn.scrollspy;t.fn.scrollspy=i,t.fn.scrollspy.Constructor=e,t.fn.scrollspy.noConflict=function(){return t.fn.scrollspy=o,this},t(window).on('load.bs.scrollspy.data-api',function(){t('[data-spy="scroll"]').each(function(){var e=t(this);i.call(e,e.data())})})}(jQuery),+function(t){'use strict';function o(i){return this.each(function(){var s=t(this),o=s.data('bs.tab');o||s.data('bs.tab',o=new e(this)),'string'==typeof i&&o[i]()})};var e=function(e){this.element=t(e)};e.VERSION='3.3.0',e.TRANSITION_DURATION=150,e.prototype.show=function(){var e=this.element,a=e.closest('ul:not(.dropdown-menu)'),i=e.data('target');if(i||(i=e.attr('href'),i=i&&i.replace(/.*(?=#[^\s]*$)/,'')),!e.parent('li').hasClass('active')){var o=a.find('.active:last a'),n=t.Event('hide.bs.tab',{relatedTarget:e[0]}),r=t.Event('show.bs.tab',{relatedTarget:o[0]});if(o.trigger(n),e.trigger(r),!r.isDefaultPrevented()&&!n.isDefaultPrevented()){var s=t(i);this.activate(e.closest('li'),a),this.activate(s,s.parent(),function(){o.trigger({type:'hidden.bs.tab',relatedTarget:e[0]}),e.trigger({type:'shown.bs.tab',relatedTarget:o[0]})})}}},e.prototype.activate=function(i,o,s){function a(){n.removeClass('active').find('> .dropdown-menu > .active').removeClass('active').end().find('[data-toggle="tab"]').attr('aria-expanded',!1),i.addClass('active').find('[data-toggle="tab"]').attr('aria-expanded',!0),r?(i[0].offsetWidth,i.addClass('in')):i.removeClass('fade'),i.parent('.dropdown-menu')&&i.closest('li.dropdown').addClass('active').end().find('[data-toggle="tab"]').attr('aria-expanded',!0),s&&s()};var n=o.find('> .active'),r=s&&t.support.transition&&(n.length&&n.hasClass('fade')||!!o.find('> .fade').length);n.length&&r?n.one('bsTransitionEnd',a).emulateTransitionEnd(e.TRANSITION_DURATION):a(),n.removeClass('in')};var s=t.fn.tab;t.fn.tab=o,t.fn.tab.Constructor=e,t.fn.tab.noConflict=function(){return t.fn.tab=s,this};var i=function(e){e.preventDefault(),o.call(t(this),'show')};t(document).on('click.bs.tab.data-api','[data-toggle="tab"]',i).on('click.bs.tab.data-api','[data-toggle="pill"]',i)}(jQuery),+function(t){'use strict';function i(i){return this.each(function(){var s=t(this),o=s.data('bs.affix'),n='object'==typeof i&&i;o||s.data('bs.affix',o=new e(this,n)),'string'==typeof i&&o[i]()})};var e=function(i,o){this.options=t.extend({},e.DEFAULTS,o),this.$target=t(this.options.target).on('scroll.bs.affix.data-api',t.proxy(this.checkPosition,this)).on('click.bs.affix.data-api',t.proxy(this.checkPositionWithEventLoop,this)),this.$element=t(i),this.affixed=this.unpin=this.pinnedOffset=null,this.checkPosition()};e.VERSION='3.3.0',e.RESET='affix affix-top affix-bottom',e.DEFAULTS={offset:0,target:window},e.prototype.getState=function(t,e,i,o){var s=this.$target.scrollTop(),a=this.$element.offset(),l=this.$target.height();if(null!=i&&'top'==this.affixed)return i>s?'top':!1;if('bottom'==this.affixed)return null!=i?s+this.unpin<=a.top?!1:'bottom':t-o>=s+l?!1:'bottom';var n=null==this.affixed,r=n?s:a.top,h=n?l:e;return null!=i&&i>=r?'top':null!=o&&r+h>=t-o?'bottom':!1},e.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;this.$element.removeClass(e.RESET).addClass('affix');var t=this.$target.scrollTop(),i=this.$element.offset();return this.pinnedOffset=i.top-t},e.prototype.checkPositionWithEventLoop=function(){setTimeout(t.proxy(this.checkPosition,this),1)},e.prototype.checkPosition=function(){if(this.$element.is(':visible')){var l=this.$element.height(),o=this.options.offset,n=o.top,s=o.bottom,h=t('body').height();'object'!=typeof o&&(s=n=o),'function'==typeof n&&(n=o.top(this.$element)),'function'==typeof s&&(s=o.bottom(this.$element));var i=this.getState(h,l,n,s);if(this.affixed!=i){null!=this.unpin&&this.$element.css('top','');var r='affix'+(i?'-'+i:''),a=t.Event(r+'.bs.affix');if(this.$element.trigger(a),a.isDefaultPrevented())return;this.affixed=i,this.unpin='bottom'==i?this.getPinnedOffset():null,this.$element.removeClass(e.RESET).addClass(r).trigger(r.replace('affix','affixed')+'.bs.affix')};'bottom'==i&&this.$element.offset({top:h-l-s})}};var o=t.fn.affix;t.fn.affix=i,t.fn.affix.Constructor=e,t.fn.affix.noConflict=function(){return t.fn.affix=o,this},t(window).on('load',function(){t('[data-spy="affix"]').each(function(){var o=t(this),e=o.data();e.offset=e.offset||{},null!=e.offsetBottom&&(e.offset.bottom=e.offsetBottom),null!=e.offsetTop&&(e.offset.top=e.offsetTop),i.call(o,e)})})}(jQuery);
(function(e){if(typeof define==='function'&&define.amd){define(['jquery'],e)}
else{if(typeof exports==='object'){e(require('jquery'))}
else{e(jQuery)}}}(function(e,s){if(!('indexOf' in Array.prototype)){Array.prototype.indexOf=function(e,t){if(t===s){t=0};if(t<0){t+=this.length};if(t<0){t=0};for(var i=this.length;t<i;t++){if(t in this&&this[t]===e){return t}};return-1}};function r(){var h,s,e,t,n,a,i,r;s=(new Date()).toString();e=((i=s.split('(')[1])!=null?i.slice(0,-1):0)||s.split(' ');if(e instanceof Array){a=[];for(var t=0,n=e.length;t<n;t++){r=e[t];if((h=(i=r.match(/\b[A-Z]+\b/))!==null)?i[0]:0){a.push(h)}};e=a.pop()};return e};function a(){return new Date(Date.UTC.apply(Date,arguments))};var n=function(n,a){var l=this;this.element=e(n);this.container=a.container||'body';this.language=a.language||this.element.data('date-language')||'en';this.language=this.language in i?this.language:this.language.split('-')[0];this.language=this.language in i?this.language:'en';this.isRTL=i[this.language].rtl||!1;this.formatType=a.formatType||this.element.data('format-type')||'standard';this.format=t.parseFormat(a.format||this.element.data('date-format')||i[this.language].format||t.getDefaultFormat(this.formatType,'input'),this.formatType);this.isInline=!1;this.isVisible=!1;this.isInput=this.element.is('input');this.fontAwesome=a.fontAwesome||this.element.data('font-awesome')||!1;this.bootcssVer=a.bootcssVer||(this.isInput?(this.element.is('.form-control')?3:2):(this.bootcssVer=this.element.is('.input-group')?3:2));this.component=this.element.is('.date')?(this.bootcssVer===3?this.element.find('.input-group-addon .glyphicon-th, .input-group-addon .glyphicon-time, .input-group-addon .glyphicon-remove, .input-group-addon .glyphicon-calendar, .input-group-addon .fa-calendar, .input-group-addon .fa-clock-o').parent():this.element.find('.add-on .icon-th, .add-on .icon-time, .add-on .icon-calendar, .add-on .fa-calendar, .add-on .fa-clock-o').parent()):!1;this.componentReset=this.element.is('.date')?(this.bootcssVer===3?this.element.find('.input-group-addon .glyphicon-remove, .input-group-addon .fa-times').parent():this.element.find('.add-on .icon-remove, .add-on .fa-times').parent()):!1;this.hasInput=this.component&&this.element.find('input').length;if(this.component&&this.component.length===0){this.component=!1};this.linkField=a.linkField||this.element.data('link-field')||!1;this.linkFormat=t.parseFormat(a.linkFormat||this.element.data('link-format')||t.getDefaultFormat(this.formatType,'link'),this.formatType);this.minuteStep=a.minuteStep||this.element.data('minute-step')||5;this.pickerPosition=a.pickerPosition||this.element.data('picker-position')||'bottom-right';this.showMeridian=a.showMeridian||this.element.data('show-meridian')||!1;this.initialDate=a.initialDate||new Date();this.zIndex=a.zIndex||this.element.data('z-index')||s;this.title=typeof a.title==='undefined'?!1:a.title;this.timezone=a.timezone||r();this.icons={leftArrow:this.fontAwesome?'fa-arrow-left':(this.bootcssVer===3?'glyphicon-arrow-left':'icon-arrow-left'),rightArrow:this.fontAwesome?'fa-arrow-right':(this.bootcssVer===3?'glyphicon-arrow-right':'icon-arrow-right')};this.icontype=this.fontAwesome?'fa':'glyphicon';this._attachEvents();this.clickedOutside=function(t){if(e(t.target).closest('.datetimepicker').length===0){l.hide()}};this.formatViewType='datetime';if('formatViewType' in a){this.formatViewType=a.formatViewType}
else{if('formatViewType' in this.element.data()){this.formatViewType=this.element.data('formatViewType')}};this.minView=0;if('minView' in a){this.minView=a.minView}
else{if('minView' in this.element.data()){this.minView=this.element.data('min-view')}};this.minView=t.convertViewMode(this.minView);this.maxView=t.modes.length-1;if('maxView' in a){this.maxView=a.maxView}
else{if('maxView' in this.element.data()){this.maxView=this.element.data('max-view')}};this.maxView=t.convertViewMode(this.maxView);this.wheelViewModeNavigation=!1;if('wheelViewModeNavigation' in a){this.wheelViewModeNavigation=a.wheelViewModeNavigation}
else{if('wheelViewModeNavigation' in this.element.data()){this.wheelViewModeNavigation=this.element.data('view-mode-wheel-navigation')}};this.wheelViewModeNavigationInverseDirection=!1;if('wheelViewModeNavigationInverseDirection' in a){this.wheelViewModeNavigationInverseDirection=a.wheelViewModeNavigationInverseDirection}
else{if('wheelViewModeNavigationInverseDirection' in this.element.data()){this.wheelViewModeNavigationInverseDirection=this.element.data('view-mode-wheel-navigation-inverse-dir')}};this.wheelViewModeNavigationDelay=100;if('wheelViewModeNavigationDelay' in a){this.wheelViewModeNavigationDelay=a.wheelViewModeNavigationDelay}
else{if('wheelViewModeNavigationDelay' in this.element.data()){this.wheelViewModeNavigationDelay=this.element.data('view-mode-wheel-navigation-delay')}};this.startViewMode=2;if('startView' in a){this.startViewMode=a.startView}
else{if('startView' in this.element.data()){this.startViewMode=this.element.data('start-view')}};this.startViewMode=t.convertViewMode(this.startViewMode);this.viewMode=this.startViewMode;this.viewSelect=this.minView;if('viewSelect' in a){this.viewSelect=a.viewSelect}
else{if('viewSelect' in this.element.data()){this.viewSelect=this.element.data('view-select')}};this.viewSelect=t.convertViewMode(this.viewSelect);this.forceParse=!0;if('forceParse' in a){this.forceParse=a.forceParse}
else{if('dateForceParse' in this.element.data()){this.forceParse=this.element.data('date-force-parse')}};var h=this.bootcssVer===3?t.templateV3:t.template;while(h.indexOf('{iconType}')!==-1){h=h.replace('{iconType}',this.icontype)}
while(h.indexOf('{leftArrow}')!==-1){h=h.replace('{leftArrow}',this.icons.leftArrow)}
while(h.indexOf('{rightArrow}')!==-1){h=h.replace('{rightArrow}',this.icons.rightArrow)};this.picker=e(h).appendTo(this.isInline?this.element:this.container).on({click:e.proxy(this.click,this),mousedown:e.proxy(this.mousedown,this)});if(this.wheelViewModeNavigation){if(e.fn.mousewheel){this.picker.on({mousewheel:e.proxy(this.mousewheel,this)})}
else{console.log('Mouse Wheel event is not supported. Please include the jQuery Mouse Wheel plugin before enabling this option')}};if(this.isInline){this.picker.addClass('datetimepicker-inline')}
else{this.picker.addClass('datetimepicker-dropdown-'+this.pickerPosition+' dropdown-menu')};if(this.isRTL){this.picker.addClass('datetimepicker-rtl');var o=this.bootcssVer===3?'.prev span, .next span':'.prev i, .next i';this.picker.find(o).toggleClass(this.icons.leftArrow+' '+this.icons.rightArrow)};e(document).on('mousedown touchend',this.clickedOutside);this.autoclose=!1;if('autoclose' in a){this.autoclose=a.autoclose}
else{if('dateAutoclose' in this.element.data()){this.autoclose=this.element.data('date-autoclose')}};this.keyboardNavigation=!0;if('keyboardNavigation' in a){this.keyboardNavigation=a.keyboardNavigation}
else{if('dateKeyboardNavigation' in this.element.data()){this.keyboardNavigation=this.element.data('date-keyboard-navigation')}};this.todayBtn=(a.todayBtn||this.element.data('date-today-btn')||!1);this.clearBtn=(a.clearBtn||this.element.data('date-clear-btn')||!1);this.todayHighlight=(a.todayHighlight||this.element.data('date-today-highlight')||!1);this.weekStart=0;if(typeof a.weekStart!=='undefined'){this.weekStart=a.weekStart}
else{if(typeof this.element.data('date-weekstart')!=='undefined'){this.weekStart=this.element.data('date-weekstart')}
else{if(typeof i[this.language].weekStart!=='undefined'){this.weekStart=i[this.language].weekStart}}};this.weekStart=this.weekStart%7;this.weekEnd=((this.weekStart+6)%7);this.onRenderDay=function(e){var t=(a.onRenderDay||function(){return[]})(e);if(typeof t==='string'){t=[t]};var i=['day'];return i.concat((t?t:[]))};this.onRenderHour=function(e){var t=(a.onRenderHour||function(){return[]})(e),i=['hour'];if(typeof t==='string'){t=[t]};return i.concat((t?t:[]))};this.onRenderMinute=function(e){var t=(a.onRenderMinute||function(){return[]})(e),i=['minute'];if(typeof t==='string'){t=[t]};if(e<this.startDate||e>this.endDate){i.push('disabled')}
else{if(Math.floor(this.date.getUTCMinutes()/this.minuteStep)===Math.floor(e.getUTCMinutes()/this.minuteStep)){i.push('active')}};return i.concat((t?t:[]))};this.onRenderYear=function(e){var t=(a.onRenderYear||function(){return[]})(e),i=['year'];if(typeof t==='string'){t=[t]};if(this.date.getUTCFullYear()===e.getUTCFullYear()){i.push('active')};var s=e.getUTCFullYear(),n=this.endDate.getUTCFullYear();if(e<this.startDate||s>n){i.push('disabled')};return i.concat((t?t:[]))};this.onRenderMonth=function(e){var t=(a.onRenderMonth||function(){return[]})(e),i=['month'];if(typeof t==='string'){t=[t]};return i.concat((t?t:[]))};this.startDate=new Date(-8639968443048000);this.endDate=new Date(8639968443048000);this.datesDisabled=[];this.daysOfWeekDisabled=[];this.setStartDate(a.startDate||this.element.data('date-startdate'));this.setEndDate(a.endDate||this.element.data('date-enddate'));this.setDatesDisabled(a.datesDisabled||this.element.data('date-dates-disabled'));this.setDaysOfWeekDisabled(a.daysOfWeekDisabled||this.element.data('date-days-of-week-disabled'));this.setMinutesDisabled(a.minutesDisabled||this.element.data('date-minute-disabled'));this.setHoursDisabled(a.hoursDisabled||this.element.data('date-hour-disabled'));this.fillDow();this.fillMonths();this.update();this.showMode();if(this.isInline){this.show()}};n.prototype={constructor:n,_events:[],_attachEvents:function(){this._detachEvents();if(this.isInput){this._events=[[this.element,{focus:e.proxy(this.show,this),keyup:e.proxy(this.update,this),keydown:e.proxy(this.keydown,this)}]]}
else{if(this.component&&this.hasInput){this._events=[[this.element.find('input'),{focus:e.proxy(this.show,this),keyup:e.proxy(this.update,this),keydown:e.proxy(this.keydown,this)}],[this.component,{click:e.proxy(this.show,this)}]];if(this.componentReset){this._events.push([this.componentReset,{click:e.proxy(this.reset,this)}])}}
else{if(this.element.is('div')){this.isInline=!0}
else{this._events=[[this.element,{click:e.proxy(this.show,this)}]]}}};for(var t=0,i,s;t<this._events.length;t++){i=this._events[t][0];s=this._events[t][1];i.on(s)}},_detachEvents:function(){for(var e=0,t,i;e<this._events.length;e++){t=this._events[e][0];i=this._events[e][1];t.off(i)};this._events=[]},show:function(t){this.picker.show();this.height=this.component?this.component.outerHeight():this.element.outerHeight();if(this.forceParse){this.update()};this.place();e(window).on('resize',e.proxy(this.place,this));if(t){t.stopPropagation();t.preventDefault()};this.isVisible=!0;this.element.trigger({type:'show',date:this.date})},hide:function(){if(!this.isVisible){return};if(this.isInline){return};this.picker.hide();e(window).off('resize',this.place);this.viewMode=this.startViewMode;this.showMode();if(!this.isInput){e(document).off('mousedown',this.hide)};if(this.forceParse&&(this.isInput&&this.element.val()||this.hasInput&&this.element.find('input').val())){this.setValue()};this.isVisible=!1;this.element.trigger({type:'hide',date:this.date})},remove:function(){this._detachEvents();e(document).off('mousedown',this.clickedOutside);this.picker.remove();delete this.picker;delete this.element.data().datetimepicker},getDate:function(){var e=this.getUTCDate();if(e===null){return null};return new Date(e.getTime()+(e.getTimezoneOffset()*60000))},getUTCDate:function(){return this.date},getInitialDate:function(){return this.initialDate},setInitialDate:function(e){this.initialDate=e},setDate:function(e){this.setUTCDate(new Date(e.getTime()-(e.getTimezoneOffset()*60000)))},setUTCDate:function(e){if(e>=this.startDate&&e<=this.endDate){this.date=e;this.setValue();this.viewDate=this.date;this.fill()}
else{this.element.trigger({type:'outOfRange',date:e,startDate:this.startDate,endDate:this.endDate})}},setFormat:function(e){this.format=t.parseFormat(e,this.formatType);var i;if(this.isInput){i=this.element}
else{if(this.component){i=this.element.find('input')}};if(i&&i.val()){this.setValue()}},setValue:function(){var t=this.getFormattedDate();if(!this.isInput){if(this.component){this.element.find('input').val(t)};this.element.data('date',t)}
else{this.element.val(t)};if(this.linkField){e('#'+this.linkField).val(this.getFormattedDate(this.linkFormat))}},getFormattedDate:function(e){e=e||this.format;return t.formatDate(this.date,e,this.language,this.formatType,this.timezone)},setStartDate:function(e){this.startDate=e||this.startDate;if(this.startDate.valueOf()!==8639968443048000){this.startDate=t.parseDate(this.startDate,this.format,this.language,this.formatType,this.timezone)};this.update();this.updateNavArrows()},setEndDate:function(e){this.endDate=e||this.endDate;if(this.endDate.valueOf()!==8639968443048000){this.endDate=t.parseDate(this.endDate,this.format,this.language,this.formatType,this.timezone)};this.update();this.updateNavArrows()},setDatesDisabled:function(i){this.datesDisabled=i||[];if(!e.isArray(this.datesDisabled)){this.datesDisabled=this.datesDisabled.split(/,\s*/)};var s=this;this.datesDisabled=e.map(this.datesDisabled,function(e){return t.parseDate(e,s.format,s.language,s.formatType,s.timezone).toDateString()});this.update();this.updateNavArrows()},setTitle:function(e,t){return this.picker.find(e).find('th:eq(1)').text(this.title===!1?t:this.title)},setDaysOfWeekDisabled:function(t){this.daysOfWeekDisabled=t||[];if(!e.isArray(this.daysOfWeekDisabled)){this.daysOfWeekDisabled=this.daysOfWeekDisabled.split(/,\s*/)};this.daysOfWeekDisabled=e.map(this.daysOfWeekDisabled,function(e){return parseInt(e,10)});this.update();this.updateNavArrows()},setMinutesDisabled:function(t){this.minutesDisabled=t||[];if(!e.isArray(this.minutesDisabled)){this.minutesDisabled=this.minutesDisabled.split(/,\s*/)};this.minutesDisabled=e.map(this.minutesDisabled,function(e){return parseInt(e,10)});this.update();this.updateNavArrows()},setHoursDisabled:function(t){this.hoursDisabled=t||[];if(!e.isArray(this.hoursDisabled)){this.hoursDisabled=this.hoursDisabled.split(/,\s*/)};this.hoursDisabled=e.map(this.hoursDisabled,function(e){return parseInt(e,10)});this.update();this.updateNavArrows()},place:function(){if(this.isInline){return};if(!this.zIndex){var n=0;e('div').each(function(){var t=parseInt(e(this).css('zIndex'),10);if(t>n){n=t}});this.zIndex=n+10};var i,s,t,a;if(this.container instanceof e){a=this.container.offset()}
else{a=e(this.container).offset()};if(this.component){i=this.component.offset();t=i.left;if(this.pickerPosition==='bottom-left'||this.pickerPosition==='top-left'){t+=this.component.outerWidth()-this.picker.outerWidth()}}
else{i=this.element.offset();t=i.left;if(this.pickerPosition==='bottom-left'||this.pickerPosition==='top-left'){t+=this.element.outerWidth()-this.picker.outerWidth()}};var h=document.body.clientWidth||window.innerWidth;if(t+220>h){t=h-220};if(this.pickerPosition==='top-left'||this.pickerPosition==='top-right'){s=i.top-this.picker.outerHeight()}
else{s=i.top+this.height};s=s-a.top;t=t-a.left;this.picker.css({top:s,left:t,zIndex:this.zIndex})},hour_minute:'^([0-9]|0[0-9]|1[0-9]|2[0-3]):[0-5][0-9]',update:function(){var e,i=!1;if(arguments&&arguments.length&&(typeof arguments[0]==='string'||arguments[0]instanceof Date)){e=arguments[0];i=!0}
else{e=(this.isInput?this.element.val():this.element.find('input').val())||this.element.data('date')||this.initialDate;if(typeof e==='string'){e=e.replace(/^\s+|\s+$/g,'')}};if(!e){e=new Date();i=!1};if(typeof e==='string'){if(new RegExp(this.hour_minute).test(e)||new RegExp(this.hour_minute+':[0-5][0-9]').test(e)){e=this.getDate()}};this.date=t.parseDate(e,this.format,this.language,this.formatType,this.timezone);if(i){this.setValue()};if(this.date<this.startDate){this.viewDate=new Date(this.startDate)}
else{if(this.date>this.endDate){this.viewDate=new Date(this.endDate)}
else{this.viewDate=new Date(this.date)}};this.fill()},fillDow:function(){var t=this.weekStart,e='<tr>';while(t<this.weekStart+7){e+='<th class="dow">'+i[this.language].daysMin[(t++)%7]+'</th>'};e+='</tr>';this.picker.find('.datetimepicker-days thead').append(e)},fillMonths:function(){var t='',s=new Date(this.viewDate);for(var e=0;e<12;e++){s.setUTCMonth(e);var a=this.onRenderMonth(s);t+='<span class="'+a.join(' ')+'">'+i[this.language].monthsShort[e]+'</span>'};this.picker.find('.datetimepicker-months td').html(t)},fill:function(){if(!this.date||!this.viewDate){return};var d=new Date(this.viewDate),r=d.getUTCFullYear(),p=d.getUTCMonth(),w=d.getUTCDate(),g=d.getUTCHours(),C=this.startDate.getUTCFullYear(),F=this.startDate.getUTCMonth(),b=this.endDate.getUTCFullYear(),x=this.endDate.getUTCMonth()+1,H=(new a(this.date.getUTCFullYear(),this.date.getUTCMonth(),this.date.getUTCDate())).valueOf(),D=new Date();this.setTitle('.datetimepicker-days',i[this.language].months[p]+' '+r);if(this.formatViewType==='time'){var k=this.getFormattedDate();this.setTitle('.datetimepicker-hours',k);this.setTitle('.datetimepicker-minutes',k)}
else{this.setTitle('.datetimepicker-hours',w+' '+i[this.language].months[p]+' '+r);this.setTitle('.datetimepicker-minutes',w+' '+i[this.language].months[p]+' '+r)};this.picker.find('tfoot th.today').text(i[this.language].today||i.en.today).toggle(this.todayBtn!==!1);this.picker.find('tfoot th.clear').text(i[this.language].clear||i.en.clear).toggle(this.clearBtn!==!1);this.updateNavArrows();this.fillMonths();var n=a(r,p-1,28,0,0,0,0),T=t.getDaysInMonth(n.getUTCFullYear(),n.getUTCMonth());n.setUTCDate(T);n.setUTCDate(T-(n.getUTCDay()-this.weekStart+7)%7);var m=new Date(n);m.setUTCDate(m.getUTCDate()+42);m=m.valueOf();var o=[],l;while(n.valueOf()<m){if(n.getUTCDay()===this.weekStart){o.push('<tr>')};l=this.onRenderDay(n);if(n.getUTCFullYear()<r||(n.getUTCFullYear()===r&&n.getUTCMonth()<p)){l.push('old')}
else{if(n.getUTCFullYear()>r||(n.getUTCFullYear()===r&&n.getUTCMonth()>p)){l.push('new')}};if(this.todayHighlight&&n.getUTCFullYear()===D.getFullYear()&&n.getUTCMonth()===D.getMonth()&&n.getUTCDate()===D.getDate()){l.push('today')};if(n.valueOf()===H){l.push('active')};if((n.valueOf()+86400000)<=this.startDate||n.valueOf()>this.endDate||e.inArray(n.getUTCDay(),this.daysOfWeekDisabled)!==-1||e.inArray(n.toDateString(),this.datesDisabled)!==-1){l.push('disabled')};o.push('<td class="'+l.join(' ')+'">'+n.getUTCDate()+'</td>');if(n.getUTCDay()===this.weekEnd){o.push('</tr>')};n.setUTCDate(n.getUTCDate()+1)};this.picker.find('.datetimepicker-days tbody').empty().append(o.join(''));o=[];var f='',u='',c='',S=this.hoursDisabled||[];d=new Date(this.viewDate);for(var s=0;s<24;s++){d.setUTCHours(s);l=this.onRenderHour(d);if(S.indexOf(s)!==-1){l.push('disabled')};var y=a(r,p,w,s);if((y.valueOf()+3600000)<=this.startDate||y.valueOf()>this.endDate){l.push('disabled')}
else{if(g===s){l.push('active')}};if(this.showMeridian&&i[this.language].meridiem.length===2){u=(s<12?i[this.language].meridiem[0]:i[this.language].meridiem[1]);if(u!==c){if(c!==''){o.push('</fieldset>')};o.push('<fieldset class="hour"><legend>'+u.toUpperCase()+'</legend>')};c=u;f=(s%12?s%12:12);if(s<12){l.push('hour_am')}
else{l.push('hour_pm')};o.push('<span class="'+l.join(' ')+'">'+f+'</span>');if(s===23){o.push('</fieldset>')}}
else{f=s+':00';o.push('<span class="'+l.join(' ')+'">'+f+'</span>')}};this.picker.find('.datetimepicker-hours td').html(o.join(''));o=[];f='';u='';c='';var V=this.minutesDisabled||[];d=new Date(this.viewDate);for(var s=0;s<60;s+=this.minuteStep){if(V.indexOf(s)!==-1){continue};d.setUTCMinutes(s);d.setUTCSeconds(0);l=this.onRenderMinute(d);if(this.showMeridian&&i[this.language].meridiem.length===2){u=(g<12?i[this.language].meridiem[0]:i[this.language].meridiem[1]);if(u!==c){if(c!==''){o.push('</fieldset>')};o.push('<fieldset class="minute"><legend>'+u.toUpperCase()+'</legend>')};c=u;f=(g%12?g%12:12);o.push('<span class="'+l.join(' ')+'">'+f+':'+(s<10?'0'+s:s)+'</span>');if(s===59){o.push('</fieldset>')}}
else{f=s+':00';o.push('<span class="'+l.join(' ')+'">'+g+':'+(s<10?'0'+s:s)+'</span>')}};this.picker.find('.datetimepicker-minutes td').html(o.join(''));var U=this.date.getUTCFullYear(),v=this.setTitle('.datetimepicker-months',r).end().find('.month').removeClass('active');if(U===r){v.eq(this.date.getUTCMonth()).addClass('active')};if(r<C||r>b){v.addClass('disabled')};if(r===C){v.slice(0,F).addClass('disabled')};if(r===b){v.slice(x).addClass('disabled')};o='';r=parseInt(r/10,10)*10;var M=this.setTitle('.datetimepicker-years',r+'-'+(r+9)).end().find('td');r-=1;d=new Date(this.viewDate);for(var s=-1;s<11;s++){d.setUTCFullYear(r);l=this.onRenderYear(d);if(s===-1||s===10){l.push(h)};o+='<span class="'+l.join(' ')+'">'+r+'</span>';r+=1};M.html(o);this.place()},updateNavArrows:function(){var i=new Date(this.viewDate),e=i.getUTCFullYear(),t=i.getUTCMonth(),s=i.getUTCDate(),a=i.getUTCHours();switch(this.viewMode){case 0:if(e<=this.startDate.getUTCFullYear()&&t<=this.startDate.getUTCMonth()&&s<=this.startDate.getUTCDate()&&a<=this.startDate.getUTCHours()){this.picker.find('.prev').css({visibility:'hidden'})}
else{this.picker.find('.prev').css({visibility:'visible'})};if(e>=this.endDate.getUTCFullYear()&&t>=this.endDate.getUTCMonth()&&s>=this.endDate.getUTCDate()&&a>=this.endDate.getUTCHours()){this.picker.find('.next').css({visibility:'hidden'})}
else{this.picker.find('.next').css({visibility:'visible'})};break;case 1:if(e<=this.startDate.getUTCFullYear()&&t<=this.startDate.getUTCMonth()&&s<=this.startDate.getUTCDate()){this.picker.find('.prev').css({visibility:'hidden'})}
else{this.picker.find('.prev').css({visibility:'visible'})};if(e>=this.endDate.getUTCFullYear()&&t>=this.endDate.getUTCMonth()&&s>=this.endDate.getUTCDate()){this.picker.find('.next').css({visibility:'hidden'})}
else{this.picker.find('.next').css({visibility:'visible'})};break;case 2:if(e<=this.startDate.getUTCFullYear()&&t<=this.startDate.getUTCMonth()){this.picker.find('.prev').css({visibility:'hidden'})}
else{this.picker.find('.prev').css({visibility:'visible'})};if(e>=this.endDate.getUTCFullYear()&&t>=this.endDate.getUTCMonth()){this.picker.find('.next').css({visibility:'hidden'})}
else{this.picker.find('.next').css({visibility:'visible'})};break;case 3:case 4:if(e<=this.startDate.getUTCFullYear()){this.picker.find('.prev').css({visibility:'hidden'})}
else{this.picker.find('.prev').css({visibility:'visible'})};if(e>=this.endDate.getUTCFullYear()){this.picker.find('.next').css({visibility:'hidden'})}
else{this.picker.find('.next').css({visibility:'visible'})};break}},mousewheel:function(t){t.preventDefault();t.stopPropagation();if(this.wheelPause){return};this.wheelPause=!0;var a=t.originalEvent,s=a.wheelDelta,i=s>0?1:(s===0)?0:-1;if(this.wheelViewModeNavigationInverseDirection){i=-i};this.showMode(i);setTimeout(e.proxy(function(){this.wheelPause=!1},this),this.wheelViewModeNavigationDelay)},click:function(i){i.stopPropagation();i.preventDefault();var s=e(i.target).closest('span, td, th, legend');if(s.is('.'+this.icontype)){s=e(s).parent().closest('span, td, th, legend')};if(s.length===1){if(s.is('.disabled')){this.element.trigger({type:'outOfRange',date:this.viewDate,startDate:this.startDate,endDate:this.endDate});return};switch(s[0].nodeName.toLowerCase()){case'th':switch(s[0].className){case'switch':this.showMode(1);break;case'prev':case'next':var f=t.modes[this.viewMode].navStep*(s[0].className==='prev'?-1:1);switch(this.viewMode){case 0:this.viewDate=this.moveHour(this.viewDate,f);break;case 1:this.viewDate=this.moveDate(this.viewDate,f);break;case 2:this.viewDate=this.moveMonth(this.viewDate,f);break;case 3:case 4:this.viewDate=this.moveYear(this.viewDate,f);break};this.fill();this.element.trigger({type:s[0].className+':'+this.convertViewModeText(this.viewMode),date:this.viewDate,startDate:this.startDate,endDate:this.endDate});break;case'clear':this.reset();if(this.autoclose){this.hide()};break;case'today':var r=new Date();r=a(r.getFullYear(),r.getMonth(),r.getDate(),r.getHours(),r.getMinutes(),r.getSeconds(),0);if(r<this.startDate){r=this.startDate}
else{if(r>this.endDate){r=this.endDate}};this.viewMode=this.startViewMode;this.showMode(0);this._setDate(r);this.fill();if(this.autoclose){this.hide()};break};break;case'span':if(!s.is('.disabled')){var o=this.viewDate.getUTCFullYear(),n=this.viewDate.getUTCMonth(),l=this.viewDate.getUTCDate(),h=this.viewDate.getUTCHours(),d=this.viewDate.getUTCMinutes(),u=this.viewDate.getUTCSeconds();if(s.is('.month')){this.viewDate.setUTCDate(1);n=s.parent().find('span').index(s);l=this.viewDate.getUTCDate();this.viewDate.setUTCMonth(n);this.element.trigger({type:'changeMonth',date:this.viewDate});if(this.viewSelect>=3){this._setDate(a(o,n,l,h,d,u,0))}}
else{if(s.is('.year')){this.viewDate.setUTCDate(1);o=parseInt(s.text(),10)||0;this.viewDate.setUTCFullYear(o);this.element.trigger({type:'changeYear',date:this.viewDate});if(this.viewSelect>=4){this._setDate(a(o,n,l,h,d,u,0))}}
else{if(s.is('.hour')){h=parseInt(s.text(),10)||0;if(s.hasClass('hour_am')||s.hasClass('hour_pm')){if(h===12&&s.hasClass('hour_am')){h=0}
else{if(h!==12&&s.hasClass('hour_pm')){h+=12}}};this.viewDate.setUTCHours(h);this.element.trigger({type:'changeHour',date:this.viewDate});if(this.viewSelect>=1){this._setDate(a(o,n,l,h,d,u,0))}}
else{if(s.is('.minute')){d=parseInt(s.text().substr(s.text().indexOf(':')+1),10)||0;this.viewDate.setUTCMinutes(d);this.element.trigger({type:'changeMinute',date:this.viewDate});if(this.viewSelect>=0){this._setDate(a(o,n,l,h,d,u,0))}}}}};if(this.viewMode!==0){var c=this.viewMode;this.showMode(-1);this.fill();if(c===this.viewMode&&this.autoclose){this.hide()}}
else{this.fill();if(this.autoclose){this.hide()}}};break;case'td':if(s.is('.day')&&!s.is('.disabled')){var l=parseInt(s.text(),10)||1,o=this.viewDate.getUTCFullYear(),n=this.viewDate.getUTCMonth(),h=this.viewDate.getUTCHours(),d=this.viewDate.getUTCMinutes(),u=this.viewDate.getUTCSeconds();if(s.is('.old')){if(n===0){n=11;o-=1}
else{n-=1}}
else{if(s.is('.new')){if(n===11){n=0;o+=1}
else{n+=1}}};this.viewDate.setUTCFullYear(o);this.viewDate.setUTCMonth(n,l);this.element.trigger({type:'changeDay',date:this.viewDate});if(this.viewSelect>=2){this._setDate(a(o,n,l,h,d,u,0))}};var c=this.viewMode;this.showMode(-1);this.fill();if(c===this.viewMode&&this.autoclose){this.hide()};break}}},_setDate:function(e,t){if(!t||t==='date'){this.date=e};if(!t||t==='view'){this.viewDate=e};this.fill();this.setValue();var i;if(this.isInput){i=this.element}
else{if(this.component){i=this.element.find('input')}};if(i){i.change()};this.element.trigger({type:'changeDate',date:this.getDate()});if(e===null){this.date=this.viewDate}},moveMinute:function(e,t){if(!t){return e};var i=new Date(e.valueOf());i.setUTCMinutes(i.getUTCMinutes()+(t*this.minuteStep));return i},moveHour:function(e,t){if(!t){return e};var i=new Date(e.valueOf());i.setUTCHours(i.getUTCHours()+t);return i},moveDate:function(e,t){if(!t){return e};var i=new Date(e.valueOf());i.setUTCDate(i.getUTCDate()+t);return i},moveMonth:function(e,t){if(!t){return e};var i=new Date(e.valueOf()),h=i.getUTCDate(),r=i.getUTCMonth(),o=Math.abs(t),s,a;t=t>0?1:-1;if(o===1){a=t===-1?function(){return i.getUTCMonth()===r}:function(){return i.getUTCMonth()!==s};s=r+t;i.setUTCMonth(s);if(s<0||s>11){s=(s+12)%12}}
else{for(var n=0;n<o;n++){i=this.moveMonth(i,t)};s=i.getUTCMonth();i.setUTCDate(h);a=function(){return s!==i.getUTCMonth()}}
while(a()){i.setUTCDate(--h);i.setUTCMonth(s)};return i},moveYear:function(e,t){return this.moveMonth(e,t*12)},dateWithinRange:function(e){return e>=this.startDate&&e<=this.endDate},keydown:function(e){if(this.picker.is(':not(:visible)')){if(e.keyCode===27){this.show()};return};var h=!1,t,s,a;switch(e.keyCode){case 27:this.hide();e.preventDefault();break;case 37:case 39:if(!this.keyboardNavigation){break};t=e.keyCode===37?-1:1;var i=this.viewMode;if(e.ctrlKey){i+=2}
else{if(e.shiftKey){i+=1}};if(i===4){s=this.moveYear(this.date,t);a=this.moveYear(this.viewDate,t)}
else{if(i===3){s=this.moveMonth(this.date,t);a=this.moveMonth(this.viewDate,t)}
else{if(i===2){s=this.moveDate(this.date,t);a=this.moveDate(this.viewDate,t)}
else{if(i===1){s=this.moveHour(this.date,t);a=this.moveHour(this.viewDate,t)}
else{if(i===0){s=this.moveMinute(this.date,t);a=this.moveMinute(this.viewDate,t)}}}}};if(this.dateWithinRange(s)){this.date=s;this.viewDate=a;this.setValue();this.update();e.preventDefault();h=!0};break;case 38:case 40:if(!this.keyboardNavigation){break};t=e.keyCode===38?-1:1;i=this.viewMode;if(e.ctrlKey){i+=2}
else{if(e.shiftKey){i+=1}};if(i===4){s=this.moveYear(this.date,t);a=this.moveYear(this.viewDate,t)}
else{if(i===3){s=this.moveMonth(this.date,t);a=this.moveMonth(this.viewDate,t)}
else{if(i===2){s=this.moveDate(this.date,t*7);a=this.moveDate(this.viewDate,t*7)}
else{if(i===1){if(this.showMeridian){s=this.moveHour(this.date,t*6);a=this.moveHour(this.viewDate,t*6)}
else{s=this.moveHour(this.date,t*4);a=this.moveHour(this.viewDate,t*4)}}
else{if(i===0){s=this.moveMinute(this.date,t*4);a=this.moveMinute(this.viewDate,t*4)}}}}};if(this.dateWithinRange(s)){this.date=s;this.viewDate=a;this.setValue();this.update();e.preventDefault();h=!0};break;case 13:if(this.viewMode!==0){var r=this.viewMode;this.showMode(-1);this.fill();if(r===this.viewMode&&this.autoclose){this.hide()}}
else{this.fill();if(this.autoclose){this.hide()}};e.preventDefault();break;case 9:this.hide();break};if(h){var n;if(this.isInput){n=this.element}
else{if(this.component){n=this.element.find('input')}};if(n){n.change()};this.element.trigger({type:'changeDate',date:this.getDate()})}},showMode:function(e){if(e){var i=Math.max(0,Math.min(t.modes.length-1,this.viewMode+e));if(i>=this.minView&&i<=this.maxView){this.element.trigger({type:'changeMode',date:this.viewDate,oldViewMode:this.viewMode,newViewMode:i});this.viewMode=i}};this.picker.find('>div').hide().filter('.datetimepicker-'+t.modes[this.viewMode].clsName).css('display','block');this.updateNavArrows()},reset:function(){this._setDate(null,'date')},convertViewModeText:function(e){switch(e){case 4:return'decade';case 3:return'year';case 2:return'month';case 1:return'day';case 0:return'hour'}}};var h=e.fn.datetimepicker;e.fn.datetimepicker=function(t){var a=Array.apply(null,arguments);a.shift();var i;this.each(function(){var r=e(this),h=r.data('datetimepicker'),o=typeof t==='object'&&t;if(!h){r.data('datetimepicker',(h=new n(this,e.extend({},e.fn.datetimepicker.defaults,o))))};if(typeof t==='string'&&typeof h[t]==='function'){i=h[t].apply(h,a);if(i!==s){return!1}}});if(i!==s){return i}
else{return this}};e.fn.datetimepicker.defaults={};e.fn.datetimepicker.Constructor=n;var i=e.fn.datetimepicker.dates={en:{days:['Sunday','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday','Sunday'],daysShort:['Sun','Mon','Tue','Wed','Thu','Fri','Sat','Sun'],daysMin:['Su','Mo','Tu','We','Th','Fr','Sa','Su'],months:['January','February','March','April','May','June','July','August','September','October','November','December'],monthsShort:['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'],meridiem:['am','pm'],suffix:['st','nd','rd','th'],today:'Today',clear:'Clear'}};var t={modes:[{clsName:'minutes',navFnc:'Hours',navStep:1},{clsName:'hours',navFnc:'Date',navStep:1},{clsName:'days',navFnc:'Month',navStep:1},{clsName:'months',navFnc:'FullYear',navStep:1},{clsName:'years',navFnc:'FullYear',navStep:10}],isLeapYear:function(e){return(((e%4===0)&&(e%100!==0))||(e%400===0))},getDaysInMonth:function(e,i){return[31,(t.isLeapYear(e)?29:28),31,30,31,30,31,31,30,31,30,31][i]},getDefaultFormat:function(e,t){if(e==='standard'){if(t==='input'){return'yyyy-mm-dd hh:ii'}
else{return'yyyy-mm-dd hh:ii:ss'}}
else{if(e==='php'){if(t==='input'){return'Y-m-d H:i'}
else{return'Y-m-d H:i:s'}}
else{throw new Error('Invalid format type.')}}},validParts:function(e){if(e==='standard'){return/t|hh?|HH?|p|P|z|Z|ii?|ss?|dd?|DD?|mm?|MM?|yy(?:yy)?/g}
else{if(e==='php'){return/[dDjlNwzFmMnStyYaABgGhHis]/g}
else{throw new Error('Invalid format type.')}}},nonpunctuation:/[^ -\/:-@\[-`{-~\t\n\rTZ]+/g,parseFormat:function(e,t){var i=e.replace(this.validParts(t),'\0').split('\0'),s=e.match(this.validParts(t));if(!i||!i.length||!s||s.length===0){throw new Error('Invalid date format.')};return{separators:i,parts:s}},parseDate:function(t,s,d,p,v){if(t instanceof Date){var D=new Date(t.valueOf()-t.getTimezoneOffset()*60000);D.setMilliseconds(0);return D};if(/^\d{4}\-\d{1,2}\-\d{1,2}$/.test(t)){s=this.parseFormat('yyyy-mm-dd',p)};if(/^\d{4}\-\d{1,2}\-\d{1,2}[T ]\d{1,2}\:\d{1,2}$/.test(t)){s=this.parseFormat('yyyy-mm-dd hh:ii',p)};if(/^\d{4}\-\d{1,2}\-\d{1,2}[T ]\d{1,2}\:\d{1,2}\:\d{1,2}[Z]{0,1}$/.test(t)){s=this.parseFormat('yyyy-mm-dd hh:ii:ss',p)};if(/^[-+]\d+[dmwy]([\s,]+[-+]\d+[dmwy])*$/.test(t)){var T=/([-+]\d+)([dmwy])/,o=t.match(/([-+]\d+)([dmwy])/g),l,c;t=new Date();for(var h=0;h<o.length;h++){l=T.exec(o[h]);c=parseInt(l[1]);switch(l[2]){case'd':t.setUTCDate(t.getUTCDate()+c);break;case'm':t=n.prototype.moveMonth.call(n.prototype,t,c);break;case'w':t.setUTCDate(t.getUTCDate()+c*7);break;case'y':t=n.prototype.moveYear.call(n.prototype,t,c);break}};return a(t.getUTCFullYear(),t.getUTCMonth(),t.getUTCDate(),t.getUTCHours(),t.getUTCMinutes(),t.getUTCSeconds(),0)};var o=t&&t.toString().match(this.nonpunctuation)||[],t=new Date(0,0,0,0,0,0,0),m={},w=['hh','h','ii','i','ss','s','yyyy','yy','M','MM','m','mm','D','DD','d','dd','H','HH','p','P','z','Z'],r={hh:function(e,t){return e.setUTCHours(t)},h:function(e,t){return e.setUTCHours(t)},HH:function(e,t){return e.setUTCHours(t===12?0:t)},H:function(e,t){return e.setUTCHours(t===12?0:t)},ii:function(e,t){return e.setUTCMinutes(t)},i:function(e,t){return e.setUTCMinutes(t)},ss:function(e,t){return e.setUTCSeconds(t)},s:function(e,t){return e.setUTCSeconds(t)},yyyy:function(e,t){return e.setUTCFullYear(t)},yy:function(e,t){return e.setUTCFullYear(2000+t)},m:function(e,t){t-=1;while(t<0){t+=12};t%=12;e.setUTCMonth(t);while(e.getUTCMonth()!==t){if(isNaN(e.getUTCMonth())){return e}
else{e.setUTCDate(e.getUTCDate()-1)}};return e},d:function(e,t){return e.setUTCDate(t)},p:function(e,t){return e.setUTCHours(t===1?e.getUTCHours()+12:e.getUTCHours())},z:function(){return v}},u,g,l;r.M=r.MM=r.mm=r.m;r.dd=r.d;r.P=r.p;r.Z=r.z;t=a(t.getFullYear(),t.getMonth(),t.getDate(),t.getHours(),t.getMinutes(),t.getSeconds());if(o.length===s.parts.length){for(var h=0,y=s.parts.length;h<y;h++){u=parseInt(o[h],10);l=s.parts[h];if(isNaN(u)){switch(l){case'MM':g=e(i[d].months).filter(function(){var e=this.slice(0,o[h].length),t=o[h].slice(0,e.length);return e===t});u=e.inArray(g[0],i[d].months)+1;break;case'M':g=e(i[d].monthsShort).filter(function(){var e=this.slice(0,o[h].length),t=o[h].slice(0,e.length);return e.toLowerCase()===t.toLowerCase()});u=e.inArray(g[0],i[d].monthsShort)+1;break;case'p':case'P':u=e.inArray(o[h].toLowerCase(),i[d].meridiem);break;case'z':case'Z':v;break}};m[l]=u};for(var h=0,f;h<w.length;h++){f=w[h];if(f in m&&!isNaN(m[f])){r[f](t,m[f])}}};return t},formatDate:function(s,n,h,o,d){if(s===null){return''};var a;if(o==='standard'){a={t:s.getTime(),yy:s.getUTCFullYear().toString().substring(2),yyyy:s.getUTCFullYear(),m:s.getUTCMonth()+1,M:i[h].monthsShort[s.getUTCMonth()],MM:i[h].months[s.getUTCMonth()],d:s.getUTCDate(),D:i[h].daysShort[s.getUTCDay()],DD:i[h].days[s.getUTCDay()],p:(i[h].meridiem.length===2?i[h].meridiem[s.getUTCHours()<12?0:1]:''),h:s.getUTCHours(),i:s.getUTCMinutes(),s:s.getUTCSeconds(),z:d};if(i[h].meridiem.length===2){a.H=(a.h%12===0?12:a.h%12)}
else{a.H=a.h};a.HH=(a.H<10?'0':'')+a.H;a.P=a.p.toUpperCase();a.Z=a.z;a.hh=(a.h<10?'0':'')+a.h;a.ii=(a.i<10?'0':'')+a.i;a.ss=(a.s<10?'0':'')+a.s;a.dd=(a.d<10?'0':'')+a.d;a.mm=(a.m<10?'0':'')+a.m}
else{if(o==='php'){a={y:s.getUTCFullYear().toString().substring(2),Y:s.getUTCFullYear(),F:i[h].months[s.getUTCMonth()],M:i[h].monthsShort[s.getUTCMonth()],n:s.getUTCMonth()+1,t:t.getDaysInMonth(s.getUTCFullYear(),s.getUTCMonth()),j:s.getUTCDate(),l:i[h].days[s.getUTCDay()],D:i[h].daysShort[s.getUTCDay()],w:s.getUTCDay(),N:(s.getUTCDay()===0?7:s.getUTCDay()),S:(s.getUTCDate()%10<=i[h].suffix.length?i[h].suffix[s.getUTCDate()%10-1]:''),a:(i[h].meridiem.length===2?i[h].meridiem[s.getUTCHours()<12?0:1]:''),g:(s.getUTCHours()%12===0?12:s.getUTCHours()%12),G:s.getUTCHours(),i:s.getUTCMinutes(),s:s.getUTCSeconds()};a.m=(a.n<10?'0':'')+a.n;a.d=(a.j<10?'0':'')+a.j;a.A=a.a.toString().toUpperCase();a.h=(a.g<10?'0':'')+a.g;a.H=(a.G<10?'0':'')+a.G;a.i=(a.i<10?'0':'')+a.i;a.s=(a.s<10?'0':'')+a.s}
else{throw new Error('Invalid format type.')}};var s=[],r=e.extend([],n.separators);for(var l=0,u=n.parts.length;l<u;l++){if(r.length){s.push(r.shift())};s.push(a[n.parts[l]])};if(r.length){s.push(r.shift())};return s.join('')},convertViewMode:function(e){switch(e){case 4:case'decade':e=4;break;case 3:case'year':e=3;break;case 2:case'month':e=2;break;case 1:case'day':e=1;break;case 0:case'hour':e=0;break};return e},headTemplate:'<thead><tr><th class="prev"><i class="{iconType} {leftArrow}"/></th><th colspan="5" class="switch"></th><th class="next"><i class="{iconType} {rightArrow}"/></th></tr></thead>',headTemplateV3:'<thead><tr><th class="prev"><span class="{iconType} {leftArrow}"></span> </th><th colspan="5" class="switch"></th><th class="next"><span class="{iconType} {rightArrow}"></span> </th></tr></thead>',contTemplate:'<tbody><tr><td colspan="7"></td></tr></tbody>',footTemplate:'<tfoot><tr><th colspan="7" class="today"></th></tr><tr><th colspan="7" class="clear"></th></tr></tfoot>'};t.template='<div class="datetimepicker"><div class="datetimepicker-minutes"><table class=" table-condensed">'+t.headTemplate+t.contTemplate+t.footTemplate+'</table></div><div class="datetimepicker-hours"><table class=" table-condensed">'+t.headTemplate+t.contTemplate+t.footTemplate+'</table></div><div class="datetimepicker-days"><table class=" table-condensed">'+t.headTemplate+'<tbody></tbody>'+t.footTemplate+'</table></div><div class="datetimepicker-months"><table class="table-condensed">'+t.headTemplate+t.contTemplate+t.footTemplate+'</table></div><div class="datetimepicker-years"><table class="table-condensed">'+t.headTemplate+t.contTemplate+t.footTemplate+'</table></div></div>';t.templateV3='<div class="datetimepicker"><div class="datetimepicker-minutes"><table class=" table-condensed">'+t.headTemplateV3+t.contTemplate+t.footTemplate+'</table></div><div class="datetimepicker-hours"><table class=" table-condensed">'+t.headTemplateV3+t.contTemplate+t.footTemplate+'</table></div><div class="datetimepicker-days"><table class=" table-condensed">'+t.headTemplateV3+'<tbody></tbody>'+t.footTemplate+'</table></div><div class="datetimepicker-months"><table class="table-condensed">'+t.headTemplateV3+t.contTemplate+t.footTemplate+'</table></div><div class="datetimepicker-years"><table class="table-condensed">'+t.headTemplateV3+t.contTemplate+t.footTemplate+'</table></div></div>';e.fn.datetimepicker.DPGlobal=t;e.fn.datetimepicker.noConflict=function(){e.fn.datetimepicker=h;return this};e(document).on('focus.datetimepicker.data-api click.datetimepicker.data-api','[data-provide="datetimepicker"]',function(t){var i=e(this);if(i.data('datetimepicker')){return};t.preventDefault();i.datetimepicker('show')});e(function(){e('[data-provide="datetimepicker-inline"]').datetimepicker()})}));